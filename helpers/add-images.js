...
const TARGET_FOLDER = '../lizwood-client/public/stars/'; // <<< Path to the folder containing images (relative to this script)
...
const ASSETS_BASE_PATH = '/stars';   // <<< Base path where images are served from (relative to public root)
// --- End Configuration ---
