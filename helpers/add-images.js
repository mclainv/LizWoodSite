...
const TARGET_FOLDER = '../lizwood-client/public/assets'; // <<< Path to the folder containing images (relative to this script)
const MODEL_TYPE = 'Fineart';      // <<< Category name (e.g., 'Home', 'Direction') - used for collection name and asset path
