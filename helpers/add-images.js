...
const TARGET_FOLDER = '../lizwood-client/public/arrows'; // <<< Path to the folder containing images (relative to this script)
const MODEL_TYPE = 'Music';      // <<< Category name (e.g., 'Home', 'Direction') - used for collection name and asset path
const COLLECTION_SUFFIX = 'Fixeds'; // <<< Set to 'Draggables' or 'Fixeds'
const ASSETS_BASE_PATH = '/arrows';   // <<< Base path where images are served from (relative to public root)
// --- End Configuration ---
